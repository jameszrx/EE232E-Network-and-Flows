...
setwd("C:/Users/James/Desktop/EE232/Project_1")
# read the google+ ego networks
graph_files = list.files("./gplus/")
file_ids = sub("^([^.]*).*", "\\1", graph_files)
...
cat("Total IDs with more than circles = ", length(ids_circles), "\n")
